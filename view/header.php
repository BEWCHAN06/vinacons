...
<head>
  ...
  <link rel="stylesheet" href="view/khoahoc.css">
...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid footer-main">
    <div class="navbar-header footer">
      ...
      <a class="navbar-brand nameweb" href="index.php"><img style="width: 100px;"     alt="">VINACONS</a>
      
      <a class="navbar-brand imgcourse" href="index.php"><img style="width: 90px;"   src="img/logopng.png" alt=""></a>
    </div>
    <div class="selections">
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          <li><a class="sections " href="index.php#section1">GIỚI THIỆU</a></li>
          <li><a class="sections" href="index.php#section2">KHÓA HỌC</a></li>
          <li><a class="sections" href="index.php#section3">VẤN ĐỀ</a></li>
